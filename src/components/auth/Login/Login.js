            ...
            <div className="row">
              <div className="col-md-4 col-md-offset-3 m-auto">
                ...
                <form onSubmit={loginUser}>
                  ...
                  <InputItem name="email" autoFocus required type="email" onchangeHandler={onchangeHandler} placeholder="Email" />
                  <InputItem name="password" required type="password" onchangeHandler={onchangeHandler} placeholder="Password" />
